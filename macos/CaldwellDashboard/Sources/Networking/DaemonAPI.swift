...
struct DaemonAPI: Sendable {
    ...
    func saveSettings(muted: Bool? = nil, expletivesEnabled: Bool? = nil, canonEnabled: Bool? = nil, floatingHeadEnabled: Bool? = nil, nativeVoice: String? = nil) async throws -> SettingsSaveResponse {
        var body: [String: Any] = [:]
