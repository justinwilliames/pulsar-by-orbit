...
Length: 600-900 words. Voice held. Sign off as <drone name>.
Save to <output-dir>/R1-<drone-lowercase>.md.
```

**Routing:** triage the model per drone (§3), then spawn all 7 in parallel via the Agent tool.
